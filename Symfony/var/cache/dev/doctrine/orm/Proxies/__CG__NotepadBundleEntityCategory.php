...
namespace Proxies\__CG__\NotepadBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Category extends \NotepadBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NotepadBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'NotepadBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'NotepadBundle\\Entity\\Category' . "\0" . 'notes'];
        }
